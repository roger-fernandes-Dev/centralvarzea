...
const groups: Group[] = [
  {
    name: "Grupo A",
    teams: [
      { name: "Amigos do futebol 50+", short: "ADF", logo: "/times/amigosdofutebol50.png", pts: 0, pj: 0, sg: 0 },
      { name: "Arena Martinez Bengala", short: "AMB", logo: "/times/arenamartinez50.png", pts: 0, pj: 0, sg: 0 },
      { name: "bengala", short: "BNG", logo: "/times/bengala.png", pts: 0, pj: 0, sg: 0 },
      { name: "Master Assentamento", short: "MAT", logo: "/times/assentamento50.png", pts: 0, pj: 0, sg: 0 },
    ],
    matches: [
      { home: "ADF", away: "MAT", date: "28/04", time: "19:00", },
