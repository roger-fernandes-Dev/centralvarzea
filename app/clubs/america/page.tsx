...
export const metadata = {
  title: "America em Lins | Futebol de Várzea e Time Amador",
  description:
    "O America é um dos times mais tradicionais do futebol de várzea em lins, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "America de lins",
  ...
  openGraph: {
    title: "America | Time de Várzea em lins",
    description:
      "Conheça o America equipe tradicional do futebol de várzea em lins, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/america",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/lins/america.jpg",
        width: 1200,
        height: 630,
        alt: "Time America de lins"
      },
    ],
    locale: "pt_BR",
    type: "website",
