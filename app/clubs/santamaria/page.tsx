...
export const metadata = {
  title: "Santa Maria em Lins | Futebol de Várzea e Time Amador",
  description:
    "O Molecada é um dos times mais tradicionais do futebol de várzea em lins, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Santa Maria de lins",
  ...
  openGraph: {
    title: "Santa Maria | Time de Várzea em lins",
    description:
      "Conheça o Santa Maria equipe tradicional do futebol de várzea em lins, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/santamaria",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/lins/santamaria.jpg",
        width: 1200,
        height: 630,
        alt: "Time Santa Maria de lins"
      },
    ],
    locale: "pt_BR",
    type: "website",
