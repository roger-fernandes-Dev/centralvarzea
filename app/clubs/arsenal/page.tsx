...
export const metadata = {
  title: "Arsenal em Promissão | Futebol de Várzea e Time Amador",
  description:
    "O Arsenal é um dos times mais tradicionais do futebol de várzea em Promissão, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Arsenal Promissão",
  ...
  openGraph: {
    title: "Arsenal | Time de Várzea em Promissão",
    description:
      "Conheça o Arsenal, equipe tradicional do futebol de várzea em Promissão, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/arsenal",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/arsenal.png",
        width: 1200,
        height: 630,
        alt: "Time Arsenal de Promissão"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="relative w-full h-[250px] md:h-[350px]">
        <Image
          src="/clubs/arsenal/timearsenal.png"
          alt="Time Arsenal"
          fill
