...
export const metadata = {
  title: "União da Serra em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O União da Serra é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "União da Serra de juquitiba",
    "futebol de várzea juquitiba",
    "time amador juquitiba",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol juquitiba",
    "equipe União da Serra",
  ...
  openGraph: {
    title: "União da Serra | Time de Várzea em juquitiba",
    description:
      "Conheça o União da Serra equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/uniaodaserra",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/uniaodaserra.jpg",
        width: 1200,
        height: 630,
        alt: "Time União da Serra de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/uniaodaserra.jpg"
          alt="Logo União da Serra"
          width={800}
          height={800}
