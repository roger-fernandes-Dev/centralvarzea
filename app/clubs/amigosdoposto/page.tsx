...
export const metadata = {
  title: "Amigos do Posto em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O Amigos do Posto é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Amigos do Posto de juquitiba",
    "futebol de várzea juquitiba",
    "time amador juquitiba",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol juquitiba",
    "equipe Amigos do Posto",
  ...
  openGraph: {
    title: "Amigos do Posto | Time de Várzea em juquitiba",
    description:
      "Conheça o Amigos do Posto equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/amigosdoposto",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/amigosdoposto.jpg",
        width: 1200,
        height: 630,
        alt: "Time Amigos do Posto de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/amigosdoposto.jpg"
          alt="Logo Amigos do Posto"
          width={800}
          height={800}
