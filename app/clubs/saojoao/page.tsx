...
export const metadata = {
  title: "São João em Lins | Futebol de Várzea e Time Amador",
  description:
    "O São João é um dos times mais tradicionais do futebol de várzea em lins, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "São João de lins",
  ...
  openGraph: {
    title: "São João | Time de Várzea em lins",
    description:
      "Conheça o São João equipe tradicional do futebol de várzea em lins, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/saojoao",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/lins/saojoao.jpg",
        width: 1200,
        height: 630,
        alt: "Time São João de lins"
      },
    ],
    locale: "pt_BR",
    type: "website",
