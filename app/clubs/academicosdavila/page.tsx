...
export const metadata = {
  title: "Academicos da vila em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O Academicos da vila é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Academicos da vila de juquitiba",
    "futebol de várzea juquitiba",
    "time amador juquitiba",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol juquitiba",
    "equipe Academicos da vila",
  ...
  openGraph: {
    title: "Academicos da vila | Time de Várzea em juquitiba",
    description:
      "Conheça o Academicos da vila equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/academicosdavila",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/academicosdavila.jpg",
        width: 1200,
        height: 630,
        alt: "Time Academicos da vila de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/academicosdavila.jpg"
          alt="Logo Academicos da vila"
          width={800}
          height={800}
