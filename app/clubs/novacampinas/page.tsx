...
export const metadata = {
  title: "Nova Campinas em Promissão | Futebol de Várzea e Time Amador",
  description:
    "O Nova Campinas é um dos times mais tradicionais do futebol de várzea em Promissão, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Nova Campinas Promissão",
    "futebol de várzea Promissão",
    "time amador Promissão",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol Promissão",
    "equipe Nova Campinas",
  ...
  openGraph: {
    title: "Nova Campinas | Time de Várzea em Promissão",
    description:
      "Conheça o Nova Campinas, equipe tradicional do futebol de várzea em Promissão, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/novacampinas",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/novacampinas.png",
        width: 1200,
        height: 630,
        alt: "Time Nova Campinas de Promissão"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/novacampinas.png"
          alt="Logo Nova Campinas"
          width={800}
          height={800}
