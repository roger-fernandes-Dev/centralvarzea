...
export const metadata = {
  title: "Unidos do São Victor em Osasco | Futebol de Várzea e Time Amador",
  description:
    "O Unidos do São Victor é um dos times mais tradicionais do futebol de várzea em osasco, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Unidos do São Victor de osasco",
    "futebol de várzea juquitiba",
    "time amador osasco",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol osasco",
    "equipe Unidos do São Victor",
    "futebol local osasco",
    "tradição no futebol de várzea",
    "time de bairro osasco",
    "futebol regional interior SP"
  ],
  openGraph: {
    title: "Unidos do São Victor | Time de Várzea em osasco",
    description:
      "Conheça o Unidos do São Victor equipe tradicional do futebol de várzea em osasco, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/unidosdosaovictor",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/osasco/unidosdosaovictor.png",
        width: 1200,
        height: 630,
        alt: "Time Unidos do São Victor de osasco"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/osasco/unidosdosaovictor.png"
          alt="Logo Unidos do São Victor"
          width={800}
          height={800}
