...
export const metadata = {
  title: "Vila Izabel em Osasco | Futebol de Várzea e Time Amador",
  description:
    "O Vila Izabel é um dos times mais tradicionais do futebol de várzea em osasco, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Vila Izabel de osasco",
  ...
  openGraph: {
    title: "Vila Izabel | Time de Várzea em osasco",
    description:
      "Conheça o Vila Izabel equipe tradicional do futebol de várzea em osasco, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/vilaizabelosasco",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/osasco/vilaizabelosasco.png",
        width: 1200,
        height: 630,
        alt: "Time Vila Izabel de osasco"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/osasco/vilaizabelosasco.png"
          alt="Logo Vila Izabel"
          width={800}
          height={800}
