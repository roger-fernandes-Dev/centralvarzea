...
export const metadata = {
  title: "Villa Real em Lins | Futebol de Várzea e Time Amador",
  description:
    "O Villa Real é um dos times mais tradicionais do futebol de várzea em lins, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Villa Real de lins",
  ...
  openGraph: {
    title: "Villa Real | Time de Várzea em lins",
    description:
      "Conheça o Villa Real equipe tradicional do futebol de várzea em lins, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/villareal",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/lins/villareal.jpg",
        width: 1200,
        height: 630,
        alt: "Time Villa Real de lins"
      },
    ],
    locale: "pt_BR",
    type: "website",
