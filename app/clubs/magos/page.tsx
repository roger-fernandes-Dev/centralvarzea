...
export const metadata = {
  title: "Magos Guaiçara em Guaiçara | Futebol de Várzea e Time Amador",
  description:
    "O Magos Guaiçara é um dos times mais tradicionais do futebol de várzea em Guaiçara, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Magos Guaiçara Guaiçara",
    "futebol de várzea Guaiçara",
    "time amador Guaiçara",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol Guaiçara",
    "equipe Magos Guaiçara",
  ...
  openGraph: {
    title: "Magos Guaiçara | Time de Várzea em Promissão",
    description:
      "Conheça o Magos Guaiçara, equipe tradicional do futebol de várzea em Guaiçara, com história, união e destaque em campeonatos amadores.",
