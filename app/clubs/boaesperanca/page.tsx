...
export const metadata = {
  title: "Boa Esperança em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O Boa Esperança é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Boa Esperança de juquitiba",
  ...
  openGraph: {
    title: "Boa Esperança | Time de Várzea em juquitiba",
    description:
      "Conheça o Boa Esperança equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/boaesperanca",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/boaesperanca.jpg",
        width: 1200,
        height: 630,
        alt: "Time Boa Esperança de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/boaesperanca.jpg"
          alt="Logo Boa Esperança"
          width={800}
          height={800}
