...
export const metadata = {
  title: "Sintonia FC em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O Sintonia FC é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Sintonia FC de juquitiba",
  ...
  openGraph: {
    title: "Sintonia FC | Time de Várzea em juquitiba",
    description:
      "Conheça o Sintonia FC equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/sintopniafc",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/sintoniafc.jpg",
        width: 1200,
        height: 630,
        alt: "Time Sintonia FC de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/sintoniafc.jpg"
          alt="Logo Sintonia FC"
          width={800}
          height={800}
