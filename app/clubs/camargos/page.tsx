...
export const metadata = {
  title: "Camargos em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O Camargos é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Camargos de juquitiba",
  ...
  openGraph: {
    title: "Camargos | Time de Várzea em juquitiba",
    description:
      "Conheça o Camargos equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/camargos",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/camargos.jpg",
        width: 1200,
        height: 630,
        alt: "Time Camargos de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/camargos.jpg"
          alt="Logo Camargos"
          width={800}
          height={800}
