...
export const metadata = {
  title: "Olaria FC em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O Olaria FC é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Olaria FC de juquitiba",
  ...
  openGraph: {
    title: "Olaria FC | Time de Várzea em juquitiba",
    description:
      "Conheça o Olaria FC equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/olariafc",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/olariafc.jpg",
        width: 1200,
        height: 630,
        alt: "Time Olaria FC de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/olariafc.jpg"
          alt="Logo Olaria FC"
          width={800}
          height={800}
