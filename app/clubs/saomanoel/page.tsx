...
export const metadata = {
  title: "São Manoel em Lins | Futebol de Várzea e Time Amador",
  description:
    "O São Manoel é um dos times mais tradicionais do futebol de várzea em lins, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "São Manoel de lins",
  ...
  openGraph: {
    title: "São Manoel | Time de Várzea em lins",
    description:
      "Conheça o Molecada equipe tradicional do futebol de várzea em lins, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/saomanoel",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/lins/saomanoel.jpg",
        width: 1200,
        height: 630,
        alt: "Time São Manoel de lins"
      },
    ],
    locale: "pt_BR",
    type: "website",
