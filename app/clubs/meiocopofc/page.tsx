...
export const metadata = {
  title: "Meio copo fc em juquitiba | Futebol de Várzea e Time Amador",
  description:
  ...
  openGraph: {
    title: "Meio copo fc | Time de Várzea em juquitiba",
    description:
      "Conheça o Meio copo fc equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/meiocopofc",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/meiocopofc.jpg",
        width: 1200,
        height: 630,
        alt: "Time Meio copo fc de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/meiocopofc.jpg"
          alt="Logo Meio copo fc"
          width={800}
          height={800}
