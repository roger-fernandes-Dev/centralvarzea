...
export const metadata = {
  title: "cruzeiro do salla em penápolis | Futebol de Várzea e Time Amador",
  description:
    "O cruzeiro do salla é um dos times mais tradicionais do futebol de várzea em penápolis, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "cruzeiro do salla penapolis",
    "futebol de várzea penapolis",
    "time amador penapolis",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol penapolis",
    "equipe cruzeiro do salla",
    "futebol local penapolis",
    "tradição no futebol de várzea",
    "time de bairro penapolis",
    "futebol regional interior SP"
  ],
  openGraph: {
    title: "cruzeiro do salla | Time de Várzea em penapolis",
    description:
      "Conheça o cruzeiro do salla, equipe tradicional do futebol de várzea em penapolis, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/cruzeirodosalla",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/cruzeirodosalla.png",
        width: 1200,
        height: 630,
        alt: "Time cruzeiro do salla de penapolis"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/cruzeirodosalla.png"
          alt="Logo cruzeiro do salla"
          width={800}
          height={800}
