...
export const metadata = {
  title: "São José em Promissão | Futebol de Várzea e Time Amador",
  description:
    "O São José é um dos times mais tradicionais do futebol de várzea em Promissão, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "São José Promissão",
  ...
  openGraph: {
    title: "São José | Time de Várzea em Promissão",
    description:
      "Conheça o São José, equipe tradicional do futebol de várzea em Promissão, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/saojose",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/saojose.png",
        width: 1200,
        height: 630,
        alt: "Time São José de Promissão"
      },
    ],
    locale: "pt_BR",
    type: "website",
