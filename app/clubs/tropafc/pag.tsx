...
export const metadata = {
  title: "Tropa FC em juquitiba | Futebol de Várzea e Time Amador",
  description:
    "O Tropa FC é um dos times mais tradicionais do futebol de várzea em juquitiba, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Tropa FC de juquitiba",
  ...
  openGraph: {
    title: "Tropa FC | Time de Várzea em juquitiba",
    description:
      "Conheça o Tropa FC equipe tradicional do futebol de várzea em juquitiba, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/tropafc",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/juquitiba/tropafc.jpg",
        width: 1200,
        height: 630,
        alt: "Time Tropa FC de juquitiba"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/juquitiba/tropafc.jpg"
          alt="Logo Tropa FC"
          width={800}
          height={800}
