...
export const metadata = {
  title: "Max Elite em lins | Futebol de Várzea e Time Amador",
  description:
    "O Max Elite é um dos times mais tradicionais do futebol de várzea em Guaiçara, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Max Elite",
  ...
  openGraph: {
    title: "Max Elite | Time de Várzea em Promissão",
    description:
      "Conheça o Max Elite, equipe tradicional do futebol de várzea em lins, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/maxelite",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/maxelite.png",
        width: 1200,
        height: 630,
        alt: "Time max elite de lins"
      },
    ],
    locale: "pt_BR",
    type: "website",
