...
export const metadata = {
  title: "Bulldogs em Promissão | Futebol de Várzea e Time Amador",
  description:
    "O Bulldogs é um dos times mais tradicionais do futebol de várzea em Promissão, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Bulldogs Promissão",
  ...
  openGraph: {
    title: "Bulldogs | Time de Várzea em Promissão",
    description:
      "Conheça o Bulldogs, equipe tradicional do futebol de várzea em Promissão, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/bulldogs",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/bulldogs.png",
        width: 1200,
        height: 630,
        alt: "Time Bulldogs de Promissão"
      },
    ],
    locale: "pt_BR",
    type: "website",
