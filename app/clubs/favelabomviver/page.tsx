...
export const metadata = {
  title: "Favela Bom Viver em Lins | Futebol de Várzea e Time Amador",
  description:
    "O Favela Bom Viver é um dos times mais tradicionais do futebol de várzea em lins, com destaque em campeonatos amadores, união entre jogadores e forte presença no esporte local.",
  keywords: [
    "Favela Bom Viver de lins",
    "futebol de várzea lins",
    "time amador lins",
    "campeonatos de várzea",
    "futebol amador SP",
    "times de futebol lins",
    "equipe Favela Bom Viver",
    "futebol local lins",
  ...
  openGraph: {
    title: "Favela Bom Viver | Time de Várzea em lins",
    description:
      "Conheça o Favela Bom Viver equipe tradicional do futebol de várzea em lins, com história, união e destaque em campeonatos amadores.",
    url: "https://www.centralvarzea.com.br/clubs/favelabomviver",
    siteName: "Central Varzea",
    images: [
      {
        url: "/times/lins/favelabomviver.jpg",
        width: 1200,
        height: 630,
        alt: "Time Favela Bom Viver de lins"
      },
    ],
    locale: "pt_BR",
    type: "website",
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 -z-10">
        <Image
          src="/times/lins/favelabomviver.jpg"
          alt="Logo Favela Bom Viver"
          width={800}
          height={800}
