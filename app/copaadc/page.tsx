...
const CHAMP_ID = "copa-adc-2026"

function normalize(v: string) {
  return v.trim().toUpperCase()
}

function calculateTable(group: Group): TableTeam[] {
  const table: TableTeam[] = group.teams.map(team => ({
    ...team,
    pts: 0,
    pj: 0,
    sg: 0,
  ...
  group.matches.forEach(match => {
    ...
    const home = table.find(t => normalize(t.short) === normalize(match.home))
    const away = table.find(t => normalize(t.short) === normalize(match.away))
